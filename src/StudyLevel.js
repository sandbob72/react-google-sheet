...
class StudyLevel extends Component {
  ...
  render() {
    ...
    //   console.log('sheet1', data.Sheet1.elements);
      ...
      students = data.slice(0,4)   //รับค่าจาก google sheet ตัดค่าที่ต้องการเก็บ
    ...
    return (
      ...
      <MenuAppBar />
          <div className = "App">
            <h2>นักศึกษาที่กำลังศึกษาระดับปริญญา</h2>
              ...
              <tbody>
                {
                  students.map((item, index) => {
                    return (
                      <tr key={index}>
                        <td>{item.STUDY_LEVEL_NAME_ENG}</td>
                        <td>{item.Number_study_level}</td>
                      </tr>
                    )
                  })
                }
